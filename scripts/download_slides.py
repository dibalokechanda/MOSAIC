...
DEFAULT_OUT = Path("/users/home/dchanda/Datasets/tcga_slides_layerwise")
...
def main() -> int:
    ...
    parser.add_argument(
        "--datasets-root",
        type=Path,
        default=Path("/users/home/dchanda/Datasets"),
        help="root holding the TCGA-* manifest folders",
    )
    parser.add_argument(
        "--store-glob",
        default="/users/home/dchanda/trident_features/master_benchmark/"
